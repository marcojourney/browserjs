...
exports.getVisitorId = exports.getAttributes = exports.load = exports.prepareForSources = exports.hashComponents = exports.componentsToDebugString = void 0;
...
function load({ delayFallback, debug, monitoring = true } = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        */
        const getComponents = (0, sources_1.default)({ cache: {}, debug });
 ...
 */
function getAttributes({ delayFallback } = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        yield prepareForSources(delayFallback);
        const getComponents = (0, sources_1.default)({ cache: {} });
